...
class CreateIndicationService {
    execute(email, indicatedToId) {
        return __awaiter(this, void 0, void 0, function* () {
            const indicatedById = yield prisma_1.default.user.findFirst({
                where: {
                    email,
                },
            });
            const hasSentIndication = yield prisma_1.default.indication.findFirst({
                where: {
            ...
            const indication = yield prisma_1.default.indication.create({
                data: {
                    indicatedById: indicatedById.id,
                    indicatedToId,
                },
