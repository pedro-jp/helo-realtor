...
class UpdateImovelController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { name, description, price, local, quartos, banheiros, area, garagem, active, categoryId, marker, transaction, } = req.body; // Usar Partial para aceitar campos opcionais
